...
![](https://img.shields.io/badge/包含-MAC应用-orange.svg)
![](https://img.shields.io/badge/包含-MAC屏保-red.svg)
...
- **NetWorker V5.4.0**:可以让你在菜单栏上显示当前的网络上传下载速度，你可以在速度和流量两种模式之间切换，你也可以选择不同的网络模式来进行监测
...
---
**2元机场推荐：**
这个机场是我无意间发现的，鉴于现在国内状况的不稳定性，不推荐购买过长时间，一到三个月时间为佳。
最低三块每月20g流量，甚至订阅20个0.1元的服务可以达到2元20g的目标， 可以满足不进行过长视频观看的日常需要。
地址：https://x-ssr.club/register?aff=33346 
使用邀请码：D38F6A077165，可以获得1g的免费流量，以作测试使用。
